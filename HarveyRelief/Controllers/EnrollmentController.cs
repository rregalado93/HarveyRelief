...
namespace HarveyRelief.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        {
            var enrollments = db.Enrollments.Include(e => e.Volunter);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentID,VolunteerID,City,State,DisasterType")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
